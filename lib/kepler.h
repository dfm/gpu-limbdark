...
#ifndef _JAX_LIMBDARK_KEPLER_H_
#define _JAX_LIMBDARK_KEPLER_H_
...
#ifdef __CUDACC__
#define JAX_LIMBDARK_INLINE_OR_DEVICE __host__ __device__
#else
#define JAX_LIMBDARK_INLINE_OR_DEVICE inline
...
template <typename T>
JAX_LIMBDARK_INLINE_OR_DEVICE void compute_eccentric_anomaly(const T& mean_anom, const T& ecc,
